...
/**
 * The ERC class of the terminals.
 * It consists of
 *   (1) the terminal GP node,
 *   (2) the subpopulation index to retrieve the terminal set for node reset.
 *
 * @author gphhucarp
 */
...
public abstract class TerminalERC extends ERC {
    ...
    protected GPNode terminal; // the terminal GP node.
    protected int subpop; // the subpopulation index.
    ...
    public void setSubpop(int subpop) {
        this.subpop = subpop;
    }
