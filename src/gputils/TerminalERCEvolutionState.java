...
public abstract class TerminalERCEvolutionState extends SimpleEvolutionState {
     ...
     */
    public void setTerminalSet(int index, PrimitiveSet terminalSet) {
     ...
     */
    public void initTerminalSetsFromCsv(File csvFile, PrimitiveSet dictionary) {
        terminalSets = new ArrayList<>();
        for (int i = 0; i < population.subpops.length; i++)
            terminalSets.add(new PrimitiveSet());
