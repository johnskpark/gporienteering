        ...
        if (expression.charAt(0) == '(') {
            ...
            if (func.equals("-")) {
                ...
                if (args.get(0).startsWith("(+")) {
                    // (a + b) - a = b
                    List<String> subArgs = LispUtils.splitArguments(args.get(0).substring(3, args.get(0).length()-1));
                    if (subArgs.get(0).equals(args.get(1)))
                        return subArgs.get(1);

                    if (subArgs.get(1).equals(args.get(1)))
                        return subArgs.get(0);
                }

                if (args.get(1).startsWith("(+")) {
                    // a - (a + b) = 0 - b
                    List<String> subArgs = LispUtils.splitArguments(args.get(1).substring(3, args.get(1).length()-1));
                    if (subArgs.get(0).equals(args.get(0)))
                        return "(- 0 " + subArgs.get(1) + ")";

                    if (subArgs.get(1).equals(args.get(1)))
                        return "(- 0 " + subArgs.get(0) + ")";
                }
                ...
                if (args.get(1).startsWith("(*")) {
                    ...
                    List<String> subArgs = LispUtils.splitArguments(args.get(1).substring(3, args.get(1).length()-1));
                    if (subArgs.get(0).equals(args.get(1)))
                        return "(/ 1 " + subArgs.get(1) + ")";

                    if (subArgs.get(1).equals(args.get(1)))
                        return "(/ 1 " + subArgs.get(0) + ")";
                }
                ...
                if (args.get(1).startsWith("(-")) {
                    // a + (b - a) = b
                    List<String> subArgs = LispUtils.splitArguments(args.get(1).substring(3, args.get(1).length()-1));
                    if (subArgs.get(1).equals(args.get(0)))
                        return subArgs.get(0);
                }
                ...
                if (args.get(0).startsWith("(min")) {
                    // max(min(a, b), a) = a
                    List<String> subArgs = LispUtils.splitArguments(args.get(0).substring(5, args.get(0).length()-1));
                    if (subArgs.get(0).equals(args.get(1)) ||
                            subArgs.get(1).equals(args.get(1)))
                        return args.get(1);
                }

                if (args.get(1).startsWith("(min")) {
                    // max(a, min(a, b)) = a
                    List<String> subArgs = LispUtils.splitArguments(args.get(1).substring(5, args.get(1).length()-1));
                    if (subArgs.get(0).equals(args.get(0)) ||
                            subArgs.get(1).equals(args.get(0)))
                        return args.get(0);
                }
