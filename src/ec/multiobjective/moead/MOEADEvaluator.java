            ...
            if (rank.length + newSubpopulation.size() >= originalPopSize[subpop])
                ...
                QuickSort.qsort(rank, new SortComparator()
                    ...
                    public boolean lt(Object a, Object b)
                        ...
                        return (((MOEADMultiObjectiveFitness) i1.fitness).sparsity > ((MOEADMultiObjectiveFitness) i2.fitness).sparsity);
                        }
    ...
    public ArrayList assignFrontRanks(Subpopulation subpop)
        ...
        for(int rank = 0; rank < numRanks; rank++)
            ...
            for(int ind = 0; ind < numInds; ind++)
                ((MOEADMultiObjectiveFitness)(((Individual)(front.get(ind))).fitness)).rank = rank;
            }
        return frontsByRank;
        }
